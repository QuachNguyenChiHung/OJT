...
public class RatingController {
    ...
    public ResponseEntity<List<RatingDTO>> getRatingsByProductId(@PathVariable UUID productId) {
    ...
    public ResponseEntity<Map<String, Object>> getProductRatingStats(@PathVariable UUID productId) {
